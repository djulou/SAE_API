    ...
    return (
        <>
            ...
            <p>
                ...
                des modalités de mise à disposition du site et des services par MYLi  et de définir les conditions
            ...
            <p>
                ...
                Orchestra  se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes 
                CGU.
            </p>

            <h2 className='articles'>Article 1 : Les mentions légales</h2>

            <p>
                L'édition du site Orchestra est assurée par la Société SAS MYLi au capital de 2000000000 euros, 
                immatriculée au RCS de Peros-Guirec sous le numéro 157389243, dont le siège social est situé au 
                11 rue de la Gare, 22700, Perros-Guirec
                Numéro de téléphone : 0123456789
                Adresse e-mail : mylimusique@gmail.com.
                Le Directeur de la publication est : Jean Directeur
            </p>
            <p>
                L'hébergeur du site Orchestra est la société MuSE, dont le siège social est situé au 20 rue de la Gare,
                avec le numéro de téléphone : 9876543210.
            </p>

            <h2 className='articles'>Article 2 : Accès au site</h2>

            <p>
                Le site Orchestra  permet à l'Utilisateur un accès gratuit aux services suivants :
                Le site internet propose les services suivants :
                recommandation de musiques et d'artistes, création de playlists
            ...
            <p>
                ...
                pas la responsabilité de Orchestra. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur à 
            ...
            <h2 className='articles'>Article 3 : Collecte des données</h2>
            ...
            <h2 className='articles'>Article 4 : Propriété intellectuelle</h2>
            ...
            <h2 className='articles'>Article 5 : Responsabilité</h2>

            <p>
                Les sources des informations diffusées sur le site Orchestra sont réputées fiables mais le site ne 
            ...
            <p>
                ...
                Malgré des mises à jour régulières, le site Orchestra ne peut être tenu responsable de la modification 
                ...
                Le site Orchestra ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter 
            ...
            <h2 className='articles'>Article 6 : Liens hypertextes</h2>

            <p>
                Des liens hypertextes peuvent être présents sur le site. L’Utilisateur est informé qu’en cliquant sur ces
                liens, il sortira du site Orchestra. Ce dernier n’a pas de contrôle sur les pages web sur lesquelles 
                aboutissent ces liens et ne saurait, en aucun cas, être responsable de leur contenu.
            </p>

            <h2 className='articles'>Article 7 : Cookies</h2>
            ...
            <p>
                ...
                l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site Orchestra. Les cookies 
            ...
            <p>
                L’information contenue dans les cookies est utilisée pour améliorer le site Orchestra.
            </p>
            <p>
            ...
            <h2 className='articles'>Article 8 : Droit applicable et juridiction compétente</h2>
